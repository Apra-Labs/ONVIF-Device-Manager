...
namespace onvifmp{
	...
	///<summary></summary>
	class H265VirtualSink : public VirtualSink{
	public:
		///<summary>
		///create new H265VirtualSink object
		...
		///<returns>pointer to created H265VirtualSink object, if successed or nullptr otherwise</returns>
	...
	protected:
		...
		///<param name="usageEnvironment">usage environment</param>
		///<param name="bufferSize">max packet payload</param>
		H265VirtualSink(UsageEnvironment& evn, unsigned bufSize): VirtualSink(evn, bufSize+sizeof(StartCode4_t)){
